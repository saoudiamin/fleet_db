...
public class GpsSimulator {
    ...
    public void init() {
        try {
            ...
            System.err.println("⚠️ GpsSimulator initialization skipped: " + e.getMessage());
        }
    }
    ...
    public void simulateGPS() {
        try {
            ...
            System.err.println("⚠️ GPS simulation paused: " + e.getMessage());
        }
    }
}